      ...
      },
      {
        ...
        icon: (
          ...
          >
            ...
            <path d='M14 3v5h5' />
            <path d='M18 19c0-2.21-3.58-4-8-4s-8 1.79-8 4' />
          </svg>
        )
      },
      {
...
export const Footer = () => {
  ...
  const pathNames = ['/practice', '/result']
      ...
      <div className='max-w-[1440px] mx-auto px-6 py-12'>
        <div className='grid grid-cols-1 md:grid-cols-12 gap-4'>
          ...
          <div className='md:col-span-2'>
            <h3 className='text-xl font-semibold mb-4 text-primary1'>
              {footerMenus.courses.title}
            </h3>
            <ul className='space-y-2'>
              {footerMenus.courses.items.map((item, index) => (
                <li
                  key={index}
                  className='group flex items-center gap-3 text-gray-600 hover:text-blue-600 transition-all duration-300 cursor-pointer'
                >
